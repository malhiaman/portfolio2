...
//gridsby sanitize hover content
function gridsby_sanitize_hover_content( $input ) {
    $valid = array(
			'option1' => 'Plus Symbol ( + )',
			'option2' => 'Post Title',
			'option3' => 'Hover Text (enter text below)',
			'option4' => 'None',
			'option5' => 'Post Excerpt',
    );
