...
function gridsby_add_customizer_css() {
	...
	<style>
		...
		<?php if ( get_theme_mod( 'gridsby_static_nav_color' ) ) : ?>
		.navigation-container ul li a { color: <?php echo esc_attr( get_theme_mod( 'gridsby_static_nav_color', '#404040' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_static_nav_hover_color' ) ) : ?>
		.navigation-container ul li a:hover { color: <?php echo esc_attr( get_theme_mod( 'gridsby_static_nav_hover_color', '#b0544f' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_static_nav_hover_bg_color' ) ) : ?>
		.navigation-container ul li a:hover { background-color: <?php echo esc_attr( get_theme_mod( 'gridsby_static_nav_hover_bg_color', '#404040' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_static_nav_dropdown_bg' ) ) : ?>
		.main-navigation ul ul, .main-navigation ul li:hover > ul { background: <?php echo esc_attr( get_theme_mod( 'gridsby_static_nav_dropdown_bg', '#222222' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_static_nav_dropdown_link_color' ) ) : ?>
		.main-navigation ul ul a { color: <?php echo esc_attr( get_theme_mod( 'gridsby_static_nav_dropdown_link_color', '#cccccc' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_side_nav_bg_color' ) ) : ?>
		.cbp-spmenu { background-color: <?php echo esc_attr( get_theme_mod( 'gridsby_side_nav_bg_color', '#222222' )) ?>; }
		<?php endif; ?>
		
		<?php if ( get_theme_mod( 'gridsby_side_nav_color' ) ) : ?>
		.cbp-spmenu a { color: <?php echo esc_attr( get_theme_mod( 'gridsby_side_nav_color', '#cccccc' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_side_nav_hover_color' ) ) : ?>
		.cbp-spmenu a:hover, .cbp-spmenu ul.sub-menu li a:hover { color: <?php echo esc_attr( get_theme_mod( 'gridsby_side_nav_hover_color', '#b0544f' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_side_nav_hover_bg_color' ) ) : ?>
		.cbp-spmenu a:hover { background-color: <?php echo esc_attr( get_theme_mod( 'gridsby_side_nav_hover_bg_color', '#222222' )) ?>; }
		<?php endif; ?>  
		
		<?php if ( get_theme_mod( 'gridsby_side_nav_dropdown_color' ) ) : ?>
		.cbp-spmenu ul.sub-menu li a { color: <?php echo esc_attr( get_theme_mod( 'gridsby_side_nav_dropdown_color', '#999999' )) ?>; }
		<?php endif; ?>
		
		<?php if ( get_theme_mod( 'gridsby_close_menu_text' ) ) : ?>
		.cbp-spmenu h3 { color: <?php echo esc_attr( get_theme_mod( 'gridsby_close_menu_text', '#ededed' )) ?>; }
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'gridsby_close_menu_bg' ) ) : ?>
		.cbp-spmenu h3 { background-color: <?php echo esc_attr( get_theme_mod( 'gridsby_close_menu_bg', '#000000' )) ?>; } 
		<?php endif; ?>  
